...
let
  buildDotnetPackage_ = buildDotnetPackage.override { mono=mono510; };
  fetchNuGet_ = fetchNuGet.override { buildDotnetPackage = buildDotnetPackage_; };
  HtmlAgilityPack = fetchNuGet_ {
    baseName = "HtmlAgilityPack";
    version = "1.7.1";
    outputFiles = ["lib/Net45/*"]; # */
    sha256 = "19qicbbpmsvl1k5v98i97c1zh30wv5zwvwrpb1qvf8va4bg34crc";
  };
  SharpCompress = fetchNuGet_ {
    baseName = "SharpCompress";
    version = "0.10.3";
    sha256 = "1na5ww9n1sfmxfwhbk70nwa32gmk6sh3d1n9akgw57xfk21nb94s";
    outputFiles = ["lib/net40/*"]; # */
  };
  NewtonsoftJson_ = dotnetPackages.NewtonsoftJson;
in

buildDotnetPackage_ rec {
